...
val yylen = "\002\000\
\\002\000\001\000\001\000\001\000\003\000\003\000\003\000\000\000\
\\002\000";

val yydefred = "\000\000\
\\000\000\000\000\000\000\000\000\000\000\009\000\000\000\000\000\
\\000\000\000\000\001\000\005\000\006\000\007\000";
...
\\014\000\013\000\000\000\000\000\008\000\002\000\003\000\004\000";
...
(* Rule 1, file grammer_b.grm, line 50 *)
...
( (0, 0) ) end : int*int))
;
(* Rule 2, file grammer_b.grm, line 52 *)
...
( 0 ) end : int))
;
(* Rule 3, file grammer_b.grm, line 53 *)
...
( 0 ) end : int))
;
(* Rule 4, file grammer_b.grm, line 54 *)
...
( 0 ) end : int))
;
(* Rule 5, file grammer_b.grm, line 55 *)
...
( 0 ) end : int))
;
(* Rule 6, file grammer_b.grm, line 56 *)
...
( 0 ) end : int))
;
(* Rule 7, file grammer_b.grm, line 57 *)
...
( 0 ) end : int))
;
(* Rule 8, file grammer_b.grm, line 58 *)
