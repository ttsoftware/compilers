...
struct
                ...
                let
                    ...
                    val c = c1 @ c2 @ 
                            ...
                            [ Mips.LW (t1, t1, makeConst((rank1*2-1)*4)),
                              Mips.LW (t2, t2, makeConst((rank2*2-1)*4)) ] @
                            [ Mips.LI (iterator, "0"),
                              Mips.LABEL arrLabel,
  ...
  (* generate mips code for the default case *)
  ...
  fun compile funs =
    ...
    in [  Mips.TEXT "0x00400000",
      ...
      @  (* fixed error code for indexing errors *)
         [
            Mips.LABEL "_IllegalReduceInputArrSizeError_",
            Mips.LA ("4","_IllegalReduceInputArrSizeString_"),
